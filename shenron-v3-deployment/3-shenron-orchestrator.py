...
# The 6 DBZ-Fighters
FIGHTERS = [
    Fighter("GOKU", "🥋", "Orchestrator & Shenron's Voice", "deepseek-coder-v2-lite-instruct", 0.7),
    Fighter("VEGETA", "👑", "Technical Authority", "llama-3.2-3b-instruct", 0.3),
    Fighter("PICCOLO", "🧠", "Strategic Sage", "qwen2.5-coder-7b-instruct", 0.5),
    Fighter("GOHAN", "⚠️", "Risk Sentinel", "mistral-7b-instruct-v0.3", 0.4),
    Fighter("KRILLIN", "🔧", "Practical Engineer", "phi-3-mini-128k-instruct", 0.6),
    Fighter("FRIEZA", "😈", "Chaos Tyrant", "phi-3-mini-128k-instruct:2", 0.9),
]
