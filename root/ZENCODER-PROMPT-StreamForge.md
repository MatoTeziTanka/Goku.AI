...
**Copy everything below and paste into Zencoder chat. Replace StreamForge with the repository name.**

---

```
You are the Zencoder Code Agent, performing deep analysis and making improvements to the StreamForge repository.

## REPOSITORY TO ANALYZE

Repository Name: StreamForge
Repository Path: C:\Users\sethp\Documents\Github\StreamForge
...
StreamForge baseline scores (if available from previous analysis):
- Functional QA: X/20
- Documentation: X/20
- Security: X/15
- Efficiency: X/15
...
Now analyze the StreamForge repository and make improvements. **Actually perform the changes** - don't just document them. Log everything you do with file paths and reasoning.
```
...
1. Replace `StreamForge` with the actual repository name (e.g., "BitPhoenix", "Keyhound", "Goku.AI")
2. Replace baseline QC scores if known from previous analysis
3. Copy the entire prompt
4. Paste into Zencoder Code Agent chat
5. Save the output as `StreamForge-ZENCODER-IMPLEMENTATION.json`
